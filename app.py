...
def PredGambar(file_gmbr):
    ...
    Kualitas = ['Beras', 'Batu', 'Gabah', 'Kutu', 'MerahHitam']
    df['Kelas'] = Kualitas
    ...
    if predik_kelas == 0:
        predik_Kualitas = 'Beras'
    elif predik_kelas == 1:
         predik_Kualitas = 'Batu'
    elif predik_kelas == 2:
         predik_Kualitas = 'Gabah'
    elif predik_kelas == 3:
         predik_Kualitas == 'Kutu'
    else:
         predik_Kualitas == 'MerahHitam'
...
NUM_CLASSES = 5
cifar10_classes = ["Beras", "Batu", "Gabah", "Kutu", "MerahHitam"]
...
if __name__ == '__main__':
    ...
    model = make_model()
    model.load_weights("VGG16_1.0-best.h5")
